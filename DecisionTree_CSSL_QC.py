...
# plt.title("a. Clean Data", size=14)
...
tree_clas = DecisionTreeClassifier(max_depth=4, criterion='gini', splitter='best', max_features=None)
...
fig = go.Figure()
#SWE
fig.add_trace(go.Scatter(x=df_ML['date'], y=df_ML['sh_SWE_manual_mm'], name='sh_SWE_manual_mm', yaxis='y1'))
#Depth
fig.add_trace(go.Scatter(x=df_ML['date'], y=df_ML['sh_depth_manual_cm'], name='sh_depthmanual_cm',yaxis='y1'))
#Density
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['density_pct'], name='Density',opacity=0.8, yaxis='y2'))
#Precip
fig.add_trace(go.Scatter(x=df_ML['date'], y=df_ML['sh_precip_manual_mm'], name='sh_precip_manual_mm',yaxis='y1'))
#Temp
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['sh_tempcorrected_C'], name='sh_tempcorrected_C',opacity=0.7, yaxis='y2'))
#Temp
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['degree_hours'], name='degree_hours',opacity=0.7, yaxis='y2'))
#Soil Moistrue
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['sh_sm2_%'], line=dict(color='#8F929F'),name='sh_sm2_pct', yaxis='y2'))
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['sh_sm8_%'], line=dict(color='#8F929F'),name='sh_sm8_pct', yaxis='y2'))
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['sh_sm20_%'], line=dict(color='#8F929F'),name='sh_sm20_pct', yaxis='y2'))
#Soil Temperature
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['sh_st2_C'], line=dict(color='#8F929F'),name='sh_st2_C', yaxis='y1'))
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['sh_st8_C'], line=dict(color='#8F929F'),name='sh_st8_C', yaxis='y1'))
fig.add_trace(go.Scatter(x=df_ML['date'],y=df_ML['sh_st20_C'], line=dict(color='#8F929F'),name='sh_st20_C', yaxis='y1'))
fig.update_layout(
